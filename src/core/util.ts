...
export function printError(text: string) {
  console.log(`%c js-monitor: %c${text}`, 'color: #999;fonts-size: 12px', 'color: #ff9900;font-size: 16px;')
}

// 打印成功
export function printSuccess(options: InitOptions) {
  console.groupCollapsed('%c js-monitor is running', 'color: #1AAD19;font-size: 12px;')
